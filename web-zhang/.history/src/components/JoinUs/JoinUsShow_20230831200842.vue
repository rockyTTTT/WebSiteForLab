    ...
    <div class="join_us">
        <div class="content">
            ...
            <div class="text_area">
                ...
                <span class="join_content">Recruitment will continue until the position is filled. Applications should be addressed directly to Prof. Zhang Weixiong (please state Department of Health Technology and Informatics on the envelope). </span>
            </div>
        </div>
    </div>
 </template>
