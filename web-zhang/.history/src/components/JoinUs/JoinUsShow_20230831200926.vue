    ...
    <div class="join_us">
        <div class="content">
            ...
            <div class="text_area">
                ...
                <span class="join_content">The University’s Personal Information Collection Statement for recruitment can be found at https://www.polyu.edu.hk/hro/careers/guidelines_and_forms/pics_for_recruitment.</span>
            </div>
        </div>
    </div>
 </template>
