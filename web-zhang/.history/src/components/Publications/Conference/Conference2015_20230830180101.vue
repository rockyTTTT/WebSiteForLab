    ...
    <div class="publications_content_year">
        <div class="publications_content">
            <ul>
                ...
                <li class="publications_sentence text_area"><b>·</b>&nbsp;&nbsp;[<span style="color: #4472C4;">ml/dm</span>]&nbsp;D. Jin, Z. Chen, D. He and <b>W. Zhang</b>, Modeling with node degree preservation can accurately find communities, Proc. 29th AAAI Conf on Artificial Intelligence (AAAI-15)</li>
