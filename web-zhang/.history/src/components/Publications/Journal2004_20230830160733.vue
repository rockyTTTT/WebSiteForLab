    ...
    <div class="publications_content_year">
        <div class="publications_content">
            <ul>
                ...
                <li class="publications_sentence text_area"><b>·</b>&nbsp;&nbsp;[<span style="color: #F4B083;">AI</span>]&nbsp;W. Zhang, Conﬁguration landscape analysis and backbone guided local search: Part I: satisﬁability and maximum satisﬁability, Artiﬁcial Intelligence, 158(1):1-26, 2004.</li>
