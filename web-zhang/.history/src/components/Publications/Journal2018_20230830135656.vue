    ...
    <div class="publications_content_year">
        <div class="publications_content">
            <ul>
                ...
                <li class="publications_sentence text_area"><b>·</b>&nbsp;&nbsp;[<span style="color: #76923C;">PCMM</span>]&nbsp;Y. Zhong, P. Xuan*, X. Wang, T. Zhang, J. Li, Y. Liu and W. Zhang, A non-negative matrix factorization based method for predicting disease-associated miRNAs in miRNA-disease bilayer network, Bioinformatics, 34(2):267-77, 2018.</li>
