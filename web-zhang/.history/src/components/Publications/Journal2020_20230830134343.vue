    ...
    <div class="publications_content_year">
        <div class="publications_content">
            <ul>
                ...
                <li class="publications_sentence text_area"><b>·</b>&nbsp;&nbsp;[<span style="color: #76923C;">PCMM</span>]M. Li, D. Jin, D. He, and <b>W. Zhang</b>, Modeling with node popularities for autonomous overlapping community detection, <u><i>ACM Transactions on Information Systems</i></u>, 11(3):27, 2020.</li>
