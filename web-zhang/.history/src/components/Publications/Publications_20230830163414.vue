        ...
        <div class="content">
            <div class="publications_nav">
                <ul>
                    ...
                    <li class="publications_nav_name"><RouterLink class="research_link" to="/publications/peer-reviewed">Selected Peer-reviewed Conference Publication</RouterLink></li>
                </ul>
            </div>
            <router-view/>
        </div>
