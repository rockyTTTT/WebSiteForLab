    ...
    <div class="research-content">
        <ul>
            ...
            <li class="research_sentence">
                ...
                (e.g., the precision of heuristic function) shift (<a class="research_link" href="https://www.cse.wustl.edu/~weixiongzhang/" target="_blank"></a>Zhand and Korf, Artificial Intelligence, 79(2):241-92, 1995; Zhang and Korf, Artificial Intelligence, 81(1-2):223-39, 1996; 
                Zhang, State-Space Search, Springer, 1999). This is similar to phase transitions of spin glasses studied in physics. A simple example of a phase transition is water changing from liquid to solid ice 
