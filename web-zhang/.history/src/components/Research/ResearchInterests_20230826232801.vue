    ...
    <div class="research-content">
        <ul>
            ...
            <li class="research_sentence">
                ...
                (<a class="research_link" href="https://link.springer.com/book/10.1007/978-1-4612-1538-7" target="_blank">Zhang, Artificial Intelligence, 158:1-26, 2004</a>). For the ATSP, the control parameter is the precision of the distances between cities, which is equivalent to the number of digits used to represent distances. Intuitively, when the number of digits 
