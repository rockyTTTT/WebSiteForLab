    ...
    <div class="research-content">
        <ul>
            ...
            <li class="research_sentence">
                ...
                <br/>
                &nbsp;&nbsp;&nbsp;&nbsp;This analysis was extended to reveal phase transitions in combinatorial optimization problems, such as the asymmetric TSP (ATSP) (Zhang and Korf, Artificial Intelligence, 81(1-2):223-39, 1996) and Boolean Satisfiability 
                (<a class="research_link" href="https://www.sciencedirect.com/science/article/pii/0004370295000542" target="_blank">Zhang, Artificial Intelligence, 158:1-26, 2004</a>). For the ATSP, the control parameter is the precision of the distances between cities, which is equivalent to the number of digits used to represent distances. Intuitively, when the number of digits 
