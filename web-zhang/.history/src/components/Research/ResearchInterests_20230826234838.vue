    ...
    <div class="research-content">
        <ul>
            ...
            <li class="research_sentence">
                ...
                (Xing, Chen and Zhang, Proc. ICAPS-06; Chen, Huang, Xing and Zhang, Artificial Intelligence, 173:365-91, 2009). The overall work provided a new paradigm 
                for planning. Our MaxPlan system won the First Place Award of the Fifth International Planning Competition in 2006 (Xing, Chen and Zhang, Proc. ICAPS-06).
            </li>
        </ul>    
    </div>
 </template>
