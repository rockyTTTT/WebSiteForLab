<template>
    <div class="research-content">
        <ul>
            ...
            <li class="research_title">Transition based encoding for planning: </li>
            <li class="research_sentence">
                ...
                (<a class="research_link" href="https://www.cse.wustl.edu/~weixiongzhang/" target="_blank">Huang, Chen and Zhang, Proc. AAAI-10</a>; <a class="research_link" href="https://jair.org/index.php/jair/article/view/10751" target="_blank">Huang, Chen and Zhang, JAIR, 43:293-328, 2012). 
                ...
                This work received the Outstanding Paper Award of the 24-th AAAI Conference on Artificial Intelligence Conference in 2010 (AAA-10) (Huang, Chen and Zhang, Proc. AAAI-10), 
