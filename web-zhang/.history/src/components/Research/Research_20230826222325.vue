        ...
        <div class="content">
            <div class="research_nav">
                <ul>
                    ...
                    <li class="research_nav_name"><RouterLink class="research_link" to="/research/interests"></RouterLink>Research interests - Heuristic search, planning and optimization</li>
                </ul>
            </div>
            <router-view/>
        </div>
